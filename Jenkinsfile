pipeline {
    ...
    stages {
        stage('Build') {
            steps {
                echo 'Stage 1: Build - Compiling and packaging code using Maven build automation tool'
            }
        }
        ...
        stage('Code Analysis') {
            steps {
                echo 'Stage 3: Code Analysis - Analysing code quality and standards using Checkstyle'
            }
        }
        stage('Security Scan') {
            steps {
